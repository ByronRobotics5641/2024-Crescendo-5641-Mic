...
public class DiagShootPickupAutoR extends SequentialCommandGroup {
  /** Creates a new DiagnolSootPickupAuto. */
  public DiagShootPickupAutoR(RevSwerve drive, ShooterSubsystem shooter, IntakeSubsystem intake) {
    ...
    addCommands(
      ...
      //position robot to middle from left of speaker
